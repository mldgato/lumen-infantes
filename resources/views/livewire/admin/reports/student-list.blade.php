    ...
    <div class="card card-danger card-outline">
        <div class="card-header">
            <h5 class="m-0 text-bold">
                <i class="fas fa-filter mr-1"></i> Generar Listado de Estudiantes PDF
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12 text-right">
                    <button wire:click.prevent="download" class="btn btn-danger btn-sm shadow-sm"
                        wire:loading.attr="disabled" wire:target="download" {{ !$filterSection ? 'disabled' : '' }}>
    ...
    @push('js')
        <script>
            document.addEventListener('livewire:init', () => {
                Livewire.on('downloadAdminStudentList', (event) => {
