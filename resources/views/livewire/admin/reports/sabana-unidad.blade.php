<div>
    <div class="card card-success card-outline">
        <div class="card-header">
            <h5 class="m-0 text-bold"><i class="fas fa-filter mr-1"></i> Filtros para generar la Sábana</h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2 form-group mb-3 d-flex align-items-end">
                    <button wire:click.prevent="export" class="btn btn-success btn-sm w-100 shadow-sm"
    ...
    @push('js')
        <script>
            document.addEventListener('livewire:init', () => {
                Livewire.on('downloadSabana', (event) => {
