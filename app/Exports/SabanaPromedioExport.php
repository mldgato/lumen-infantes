    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // CONSULTA ACTUALIZADA: Solo Activos y orden alfabético estandarizado
                ...
                $sheet->setCellValue("{$promedioColLetter}2", 'Promedio General');
                ...
                foreach ($students as $idx => $student) {
                    ...
                    foreach (array_values($courseColumns) as $colIdx => $data) {
                        ...
                        if ($hasScores) {
                            $promedio = $totalPct > 0 ? (int) round($weighted) : 0;
                    ...
                    // Fórmula promedio final por fila (Promedio de promedios de cursos)
