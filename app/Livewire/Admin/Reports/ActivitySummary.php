...
class ActivitySummary extends Component
{
    ...
    public function generateReport(): void
    {
        ...
        foreach ($students->values() as $idx => $student) {
            ...
            foreach ($courseScoreData as $i => $data) {
                if ($data === null) {
                    $courses[] = ['done' => 0, 'total' => 0, 'has_activities' => false];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.reports.activity-summary', compact('years', 'levels', 'grades', 'sections', 'units'));
    }
}
